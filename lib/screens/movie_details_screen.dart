...
class MovieDetails extends StatelessWidget {
  MovieDetails({required this.movieModel, this.updateFavsMovies, super.key});
              ...
              child: ConstrainedBox(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      BackdropTrailer(movieModel: movieModel),
                      Center(
                        child: Text(
                          '${movieModel.title}',
        ...
        child: AppBar(
          ...
          actions: [
            Container(
              ...
              child: FutureBuilder(
                future: databaseHelper.searchMovie(movieModel.id!),
                builder: (context, snapshot) {
                  if (snapshot.hasData) {
                    return IconButton(
                      onPressed: () {
                        if (snapshot.data != true) {
                          databaseHelper
                              .INSERT('tblMoviesFavs', movieModel.toMap())
                          ...
                          databaseHelper
                              .DELETE('tblMoviesFavs', movieModel.id!, 'id')
                              .then((value) => flag.setflagListPost());
